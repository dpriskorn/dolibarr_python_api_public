...
#
# On Windows, no additional helpers are needed.
...
#
# Otherwise on Linux, you will need the gtk or PyQt5/PyQt4 helpers installed.
#
# gtk and PyQt4 helpers are not available for Python 3,
...
#         #  pyperclip currently does not support Cygwin,
...
#
#         if os.environ["XDG_SESSION_TYPE"] == "wayland" and _executable_exists(
#             "wl-copy"
#         ):
